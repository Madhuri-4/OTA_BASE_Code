...
#define CA_CERT_PATH "hivemq-ca.pem"   // HiveMQ CA Certificate
#define CLIENT_CERT "client.crt"       // Your generated client certificate
#define CLIENT_KEY "client.key"        // Your generated private key
